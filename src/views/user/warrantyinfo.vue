    ...
    <el-card class="form-container" shadow="never">
        <el-form :model="homeAdvertise"
            ...
            <el-form-item label="批次：" >
                <el-input v-model="homeAdvertise.batch" class="input-width"></el-input>
            </el-form-item>
            <el-form-item label="数量：">
                <el-input v-model="homeAdvertise.number" class="input-width"></el-input>
            </el-form-item>
...
<script>
    ...
    import {PostDataByAdd} from '@/api/warrantycard'
    ...
    export default {
        ...
        methods: {
            ...
            resetForm(formName) {
                PostDataByAdd(this.homeAdvertise).then(res=>{
