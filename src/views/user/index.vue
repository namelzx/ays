<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="openid" min-width="100px">
        <template slot-scope="scope">
          <span class="link-type">{{ scope.row.openid }}</span>
        </template>
      </el-table-column>

      <el-table-column label="头像" min-width="30px">
        <template slot-scope="scope">
          <img class="headimgurl" :src="scope.row.headimgurl"/>
        </template>
      </el-table-column>

      <el-table-column label="是否是业务员" min-width="30px">
        <template slot-scope="scope">{{scope.row.is_business|statusFilter}}</template>
      </el-table-column>

      <el-table-column label="是否是商家" min-width="30px">
        <template slot-scope="scope">{{scope.row.is_business|statusFilter}}</template>
      </el-table-column>

      <el-table-column label="是否是车主" min-width="30px">
        <template slot-scope="scope">{{scope.row.is_members|statusFilter}}</template>
      </el-table-column>
