<template>
    <div class="app-container">
        ...
        <div class="form filter-container">
            <el-form :inline="true" :model="listQuery" class="form-inline">
                ...
                <el-form-item>
                    <InputForm title="操作人">
                        <el-input size="mini" v-model="listQuery.userName" placeholder="操作人"></el-input>
                    </InputForm>
                </el-form-item>
    ...
    <el-button type="primary" @click="dialogVisible = false">确 定</el-button>
        ...
        <el-table
                ...
                style="width: 100%;"
        >
            <el-table-column v-for="(item,index) in cityrList" :label="item.label" align="center" :min-width="item.width"
            >
                <template slot-scope="scope">


                    <span v-if="item.field=='loginTime'">{{ scope.row[item.field] |parseTime}}</span>
...
<script>
    ...
    import { getArrByKey, pickerOptions ,parseTime} from '@/utils'
    import { GetDataByList} from '@/api/operationLog'
    ...
    export default {
        ...
        data() {
            return {
                ...
                cityrList: [
                    {label: '操作人', field: 'userName', width: 150},
                    {label: '操作模块', field: 'module', width: 80},
                    {label: '控制器', field: 'nowUrl', width: 120},
                    {label: '操作内容', field: 'desc', width: 120},
                    {label: '操作时间', field: 'create_time', width: 120},
