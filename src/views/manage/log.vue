    ...
    <div class="app-container">
        ...
        <div class="form filter-container">
            <el-form :inline="true" :model="listQuery" class="form-inline">
                ...
                <el-form-item>
                    <InputForm title="登录人">
                        <el-input size="mini" v-model="listQuery.userName" placeholder="登录人"></el-input>
                    </InputForm>
                </el-form-item>
...
<script>
    ...
    import { GetDataByList} from '@/api/Log'
    ...
    export default {
        ...
        data() {
            return {
                ...
                cityrList: [
                    {label: '登录人', field: 'userName', width: 150},
                    {label: '角色', field: 'roles', width: 80},
                    {label: '登录ip', field: 'loginIp', width: 120},
                    {label: '登录时间', field: 'loginTime', width: 120},
