      ...
      <draggable v-model="codeList" class="md" @update="datadragEnd" :options="{animation:200}">
        <div class="drag-item "
          ...
          <div class="field_title" v-else>
            <el-input v-model="item.cityname" size="mini" placeholder="请输入内容"></el-input>
          </div>
          <div>
...
<script>
  import { GetDataByList, GetIdByDelete, PostDataByAdd, PostDataByUpSort } from '@/api/position'
