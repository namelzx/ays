  ...
  <div class="mendian-container">
    ...
    <div class="shop-info">
      ...
      <div class="btn-wrap">
        ...
        <el-button size="mini" type="primary" v-if="shop.withdrawal===1" @click="handelwithdrawal(2)">关闭提现</el-button>
        <el-button size="mini" type="primary" v-if="shop.withdrawal===2" @click="handelwithdrawal(1)">打开提现</el-button>
    ...
    <el-button type="primary" size="mini" @click="handleBack">确 定</el-button>
      ...
      <el-dialog
        ...
        <div style="text-align: center;width: 100%;margin-top: 30px" v-if="shop.blacklist===2">
          <el-button type="primary" @click="handelWhite('ma')">市场拉白({{shop.marketday<356?shop.marketday+'天后到期':'永久'}})
          </el-button>
        </div>
        <div style="text-align: center;width: 100%;margin-top: 30px" v-if="shop.ecblacklist===3">
      ...
      <el-dialog
        ...
        <el-tabs v-model="activeName">
          ...
          <el-tab-pane label="修改营业信息" name="second">
            <Bussiness @handleClose='handleCloseInfo' :dialogVisible="dialogBuss" :postFrom="postFrom"></Bussiness>
