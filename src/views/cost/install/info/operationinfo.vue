        ...
        <div class="dia-content">
            <div class="c-data">
                ...
                <div class="c-content">
                    <div class="ct-item">
                        ...
                        <div class="c-input">
                            <div>{{postFrom.status}}</div>
                        </div>
                    </div>
                    <div class="ct-item">
                        <span class="label">开户行</span>
                        <div class="c-input">
                            <div>{{postFrom.bank}}</div>
                        </div>
                    </div>
            ...
            <div class="c-data">
                ...
                <div class="ct-item">
                    ...
                    <div class="c-input">
                        <div>{{postFrom.no_price}}</div>
                    </div>
                </div>
                <div class="ct-item">
                    <span class="label">客服</span>
                    <div class="c-input">
                        <div>{{postFrom.proposer}}</div>
                    </div>
                </div>
